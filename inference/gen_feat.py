...
# parser.add_argument('--inf_list', default='./toy_imgs/img.list', type=str,
#                     help='the inference list')
# parser.add_argument('--feat_list', default='./toy_imgs/feat.list', type=str,
#                     help='The save path for saving features')
parser.add_argument('--inf_list', default='./MPIE_chips/img.list', type=str,
                    help='the inference list')
parser.add_argument('--feat_list', default='./MPIE_chips/feat.list', type=str,
                    help='The save path for saving features')
...
parser.add_argument('--resume', default='/afs/crc.nd.edu/user/p/ptinsley/magface/magface_epoch_00025.pth', type=str, metavar='PATH',
                    help='path to latest checkpoint (default: none)')
